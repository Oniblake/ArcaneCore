...
//                                        = 752, see LANG_PINFO_ACC_IP
    ...
    LANG_COMMAND_ARKAGOSA_HELP                    = 1000000,
    LANG_COMMAND_ARKAGOSA_ADD_HELP                = 1000001,
    LANG_COMMAND_ARKAGOSA_EDIT_HELP               = 1000002,
    LANG_COMMAND_ARKAGOSA_REMOVE_HELP             = 1000003,
    LANG_COMMAND_ARKAGOSA_REPLACE_HELP            = 1000004,
    LANG_COMMAND_ARKAGOSA_RENAME_HELP             = 1000005,
    LANG_COMMAND_ARKAGOSA_INFO_HELP               = 1000006,

    LANG_ARKAGOSA_MSG_ADD                         = 1000007,
    LANG_ARKAGOSA_MSG_REPLACED                    = 1000008,
    LANG_ARKAGOSA_MSG_NOT_EXISTS                  = 1000009,
    LANG_ARKAGOSA_MSG_REMOVED                     = 1000010,
    LANG_ARKAGOSA_MSG_UPDATED                     = 1000011,
    LANG_ARKAGOSA_MSG_RENAMED                     = 1000012,

    LANG_MSG_PVP_ATTACK_CRITICAL                  = 1000013,
    LANG_MSG_PVP_ATTACK                           = 1000014,
    LANG_MSG_PVP_PARRY                            = 1000015,
    LANG_RPS_PVP_MISS                             = 1000016,
    LANG_RPS_HEAL                                 = 1000017,
    LANG_RPS_HEAL_DOUBLE                          = 1000018,
    LANG_RPS_HEAL_THREE                           = 1000019,
    LANG_RPS_HEAL_FAIL                            = 1000020,

    LANG_COMMAND_BS_HELP                          = 1000021,
    LANG_COMMAND_BS_SET_HELP                      = 1000022,
    LANG_COMMAND_BS_SET_CHATMODIFIER_HELP         = 1000023,
    LANG_COMMAND_BS_SET_PVE_FREE_HELP             = 1000024,
    LANG_COMMAND_BS_SET_PVE_ATTACK_MELEE_HELP     = 1000025,
    LANG_COMMAND_BS_SET_PVE_ATTACK_RANGED_HELP    = 1000026,
    LANG_COMMAND_BS_SET_PVE_ATTACK_MAGIC_HELP     = 1000027,
    LANG_COMMAND_BS_SET_PVE_DEFENSE_MELEE_HELP    = 1000028,
    LANG_COMMAND_BS_SET_PVE_DEFENSE_RANGED_HELP   = 1000029,
    LANG_COMMAND_BS_SET_PVE_DEFENSE_MAGIC_HELP    = 1000030,
    LANG_COMMAND_BS_SET_PVE_HEAL_HELP             = 1000031,
    LANG_COMMAND_BS_SET_PVP_FREE_HELP             = 1000032,
    LANG_COMMAND_BS_SET_PVP_DAMAGE_HELP           = 1000033,
    LANG_COMMAND_BS_SET_PVP_ARMOR_HELP            = 1000034,
    LANG_COMMAND_BS_SET_PVP_CRITICAL_HELP         = 1000035,
    LANG_COMMAND_BS_SET_PVP_HEAL_HELP             = 1000036,
    
    LANG_MSG_PVE_FREE_SUCCESS                     = 1000037,
    LANG_MSG_ATTACK_MELEE_SUCCESS                 = 1000038,
    LANG_MSG_ATTACK_RANGED_SUCCESS                = 1000039,
    LANG_MSG_ATTACK_MAGIC_SUCCESS                 = 1000040,
    LANG_MSG_DEFENSE_MELEE_SUCCESS                = 1000041,
    LANG_MSG_DEFENSE_RANGED_SUCCESS               = 1000042,
    LANG_MSG_DEFENSE_MAGIC_SUCCESS                = 1000043,
    LANG_MSG_HEAL_SUCCESS                         = 1000044,
    LANG_MSG_PVP_FREE_SUCCESS                     = 1000045,
    LANG_MSG_PVP_ATTACK_SUCCESS                   = 1000046,
    LANG_MSG_PVP_ARMOR_SUCCESS                    = 1000047,
    LANG_MSG_PVP_CRITICAL_SUCCESS                 = 1000048,
    LANG_MSG_PVP_HEAL_SUCCESS                     = 1000049,
    LANG_MSG_CHATMODIFIER_SUCCESS                 = 1000050,

    LANG_MSG_ATTACK_MELEE_ROLL                    = 1000051,
    LANG_MSG_ATTACK_RANGED_ROLL                   = 1000052,
    LANG_MSG_ATTACK_MAGIC_ROLL                    = 1000053,
    LANG_MSG_ATTACK_DEFENSE_MELEE_ROLL            = 1000054,
    LANG_MSG_ATTACK_DEFENSE_RANGED_ROLL           = 1000055,
    LANG_MSG_ATTACK_DEFENSE_MAGIC_ROLL            = 1000056,
    LANG_MSG_HEAL_ROLL                            = 1000057,

    LANG_COMMAND_ARCANIUM_HELP                    = 1000058,
};
#endif
