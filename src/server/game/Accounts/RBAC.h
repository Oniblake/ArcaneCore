...
enum RBACPermissions
{
    ...
    // Arkagosa
    COMMAND_ARKAGOSA                                         = 1000000,
    COMMAND_ARKAGOSA_ADD                                     = 1000001,
    COMMAND_ARKAGOSA_EDIT                                    = 1000002,
    COMMAND_ARKAGOSA_REMOVE                                  = 1000003,
    COMMAND_ARKAGOSA_REPLACE                                 = 1000004,
    COMMAND_ARKAGOSA_RENAME                                  = 1000005,
    COMMAND_ARKAGOSA_INFO                                    = 1000006,
    // BattleSystem
    COMMAND_BS                                               = 1000007,
    COMMAND_BS_SET                                           = 1000008,
    COMMAND_BS_SET_CHATMODIFIER                              = 1000009,
    COMMAND_BS_SET_PVE_FREE                                  = 1000010,
    COMMAND_BS_SET_PVE_ATTACK_MELEE                          = 1000011,
    COMMAND_BS_SET_PVE_ATTACK_RANGED                         = 1000012,
    COMMAND_BS_SET_PVE_ATTACK_MAGIC                          = 1000013,
    COMMAND_BS_SET_PVE_DEFENSE_MELEE                         = 1000014,
    COMMAND_BS_SET_PVE_DEFENSE_RANGED                        = 1000015,
    COMMAND_BS_SET_PVE_DEFENSE_MAGIC                         = 1000016,
    COMMAND_BS_SET_PVE_HEAL                                  = 1000017,
    COMMAND_BS_SET_PVP_FREE                                  = 1000018,
    COMMAND_BS_SET_PVP_DAMAGE                                = 1000019,
    COMMAND_BS_SET_PVP_ARMOR                                 = 1000020,
    COMMAND_BS_SET_PVP_CRITICAL                              = 1000021,
    COMMAND_BS_SET_PVP_HEAL                                  = 1000022,
    COMMAND_BS_INFO                                          = 1000023,

    COMMAND_DISPLAY_HEAD                                     = 1000024,
    COMMAND_DISPLAY_SHOULDERS                                = 1000025,
    COMMAND_DISPLAY_SHIRT                                    = 1000026,
    COMMAND_DISPLAY_CHEST                                    = 1000027,
    COMMAND_DISPLAY_WAIST                                    = 1000028,
    COMMAND_DISPLAY_LEGS                                     = 1000029,
    COMMAND_DISPLAY_FEET                                     = 1000030,
    COMMAND_DISPLAY_WRISTS                                   = 1000031,
    COMMAND_DISPLAY_HANDS                                    = 1000032,
    COMMAND_DISPLAY_BACK                                     = 1000033,
    COMMAND_DISPLAY_TABARD                                   = 1000034,
    COMMAND_DISPLAY_MAINHAND                                 = 1000035,
    COMMAND_DISPLAY_OFFHAND                                  = 1000036,
    COMMAND_DISPLAY_LIST                                     = 1000037,
    COMMAND_DISPLAY                                          = 1000038,

    COMMAND_ARCANIUM                                         = 1000039,
    COMMAND_ARCANIUM_GET                                     = 1000040,
    COMMAND_ARCANIUM_GET_STATS                               = 1000041,
    COMMAND_ARCANIUM_GET_DISPLAY                             = 1000042,
    COMMAND_ARCANIUM_SAY                                     = 1000043,
    COMMAND_ARCANIUM_EMOTE                                   = 1000044,

    COMMAND_BS_LEARN                                         = 1000045,
    COMMAND_RPS                                              = 1000046,
    COMMAND_RPS_SET                                          = 1000047,
    COMMAND_RPS_SET_SCALE                                    = 1000048,
    COMMAND_RPS_CHANGE                                       = 1000049,
    COMMAND_RPS_CHANGE_SCALE                                 = 1000050,
    COMMAND_RPS_BARBERSHOP                                   = 1000051,

    COMMAND_RPS_SET_ANIMKIT                                  = 1000052,
    COMMAND_BS_CAST                                          = 1000053,
    RBAC_PERM_MAX
};
